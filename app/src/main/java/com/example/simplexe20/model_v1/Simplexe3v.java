package com.example.simplexe20.model_v1;
...
public class Simplexe3v {
    final float[] tb_e1 = new float[8];
    final float[] tb_e1prim = new float[8];

    final float[] tb_e2 = new float[8];
    final float[] tb_e2prim = new float[8];

    final float[] tb_e3 = new float[8];
    final float[] tb_e3prim = new float[8];

    final float[] tb_Z = new float[8];
    final float[] tb_Zprim = new float[8];

    float[] tb_libelle = new float[8];
    final float[] tb_ligne_pivot = new float[8];
...
/*
    ...
    public void determinerPivot() {
        ...
        V_entrant = Max(tb_Z[0], tb_Z[1], tb_Z[2], tb_Z[3], tb_Z[4], tb_Z[5]);
