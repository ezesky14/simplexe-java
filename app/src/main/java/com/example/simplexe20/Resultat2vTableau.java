...
public class Resultat2vTableau extends AppCompatActivity {
    Toolbar toolbar;
    String id_enreg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Resultat2vTableau.this.getTheme().resolveAttribute(R.attr.colorPrimaryDark, typedValueColorPrimaryDark, true);
    ...
    private void setLabelTexts(String[] VhbLabels, String[] VdbLabels) {
        ...
        lab_p1.setText(VhbLabels[2]);
        lab_p2.setText(VhbLabels[3]);
        lab_p3.setText(VhbLabels[4]);
    }
